...
public class InitialLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView lblTodayDate = findViewById(R.id.lblTodayDate);
        lblTodayDate.setText(HelperClass.getCurrentTime());

        TextView lblTodayTime = findViewById(R.id.lblTodayTime);
        lblTodayTime.setText(HelperClass.getCurrentDate());
